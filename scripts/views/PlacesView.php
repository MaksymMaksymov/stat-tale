...
<body>
  <?php
    ...
    if (isset($get_info) && $get_info -> model_array != null) {
      $arr_classes = array("frontier",array("specialization","sort"),array("city","sort"),array("race","sort"),array("stability","sort"),array("freedom","sort"),array("production","sort"),array("transport","sort"),array("safety","sort"),array("time","sort"),array("culture","sort"),array("area","sort"),array("size","sort"),array("economy","sort"),array("power","sort"),array("power_in","sort"),array("power_out","sort"));
