...
<body>
  <?php
    ...
    if (isset($get_info) && $get_info -> masters != null) {
      $arr_classes = array(array("master","sort"),"job_type","race",array("practic","sort"),array("cosmetic","sort"),array("city","sort"),array("integrity","sort"),array("power","sort"),array("power_in","sort"),array("power_out","sort"),"job",array("positive","sort"),array("negative","sort"));
